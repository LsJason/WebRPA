    ...
    <>
      <div className="space-y-2">
        ...
        >
          ...
          {assets.map(asset => (
            <option key={asset.id} value={asset.originalName}>
              {asset.originalName}
            </option>
          ))}
        </Select>
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              onChange={(e) => onChange('cellAddress', e.target.value)}
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => onChange('startCell', e.target.value)}
                  placeholder="如 A1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => onChange('endCell', e.target.value)}
                  placeholder="如 C10"
                />
              </div>
            </div>
